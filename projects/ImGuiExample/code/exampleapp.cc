...
ImGuiExampleApp::Open()
{
	...
	if (this->window->Open())
	{
		...
		strncpy_s(this->vsBuffer, STRING_BUFFER_SIZE, vertexShaderSource, STRING_BUFFER_SIZE);
		strncpy_s(this->fsBuffer, STRING_BUFFER_SIZE, pixelShaderSource, STRING_BUFFER_SIZE);
