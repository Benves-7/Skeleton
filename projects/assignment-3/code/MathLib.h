...
public:
	...
	/// Konstruktorer
	Matrix4D(float x1 = 0, float y1 = 0, float z1 = 0, float w1 = 0, float x2 = 0, float y2 = 0, float z2 = 0, float w2 = 0, float x3 = 0, float y3 = 0, float z3 = 0, float w3 = 0, float x4 = 0, float y4 = 0, float z4 = 0, float w4 = 0);
	...
	float* GetPointer();
	static Matrix4D lookAt(Vector4D R, Vector4D U, Vector4D D, Vector4D P);
